...
app.delete("/accounts/:id" ,(req: Request, res: Response) => {
    ...
    //só deletar caso o indice seja valido (ou seja, encontrou o item)
    if(indexToRemove >= 0) {
        //splice para editar diretamente o array accounts
        //primeiro arg é o indice alvo
        //sergunto arg é quantos itens serão removidos a partir do alvo
...
app.put("/accounts/:id", (req: Request, res: Response) => {
    ...
    res.status(200).send("Aualização realizada com sucesso")
})